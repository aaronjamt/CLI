...
class CanvasAPI {
    ...
    public:
        ...
        std::optional<nlohmann::json> _requestURL(std::string url, nlohmann::json post_data, std::optional<std::string> file_path, std::string file_param);

        // Combine the endpoint with the base URL
        std::optional<nlohmann::json> _request(const char *endpoint, nlohmann::json post_data, std::optional<std::string> file_path, std::string file_param) {
            ...
            return _requestURL(url, post_data, file_path, file_param);
        };
